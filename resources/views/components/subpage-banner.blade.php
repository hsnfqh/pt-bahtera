@props([
    'titleId' => '',
    'titleEn' => '',
    'subtitleId' => 'PT. BAHTERA KESELAMATAN SENTOSA • Crewing & Manning Services',
    'subtitleEn' => 'PT. BAHTERA KESELAMATAN SENTOSA • Crewing & Manning Services',
...
<section class="relative min-h-[42vh] sm:min-h-[48vh] lg:min-h-[52vh] flex items-center py-20 sm:py-28 lg:py-36 text-white overflow-hidden border-b-2 border-[#FFB800]/30 shadow-2xl">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/hero-banner.jpg') }}" alt="Armada Kapal PT. Bahtera Keselamatan Sentosa" class="w-full h-full object-cover object-center scale-105 filter saturate-110">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div class="flex-shrink-0 flex items-center space-x-4 bg-[#061838]/85 backdrop-blur-md px-6 py-5 rounded-2xl shadow-2xl border-2 border-[#FFB800]/50 fade-in-right">
                <div class="w-14 h-14 flex-shrink-0">
                    <img src="{{ asset('images/logo-emblem.svg') }}" alt="Emblem PT. Bahtera Keselamatan Sentosa" class="w-full h-full object-contain">
                </div>
                <div class="flex flex-col text-left">
                    <span class="text-xs sm:text-sm font-black text-white tracking-wide">PT. BAHTERA KESELAMATAN SENTOSA</span>
