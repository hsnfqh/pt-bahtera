...
<head>
    ...
    <title>@yield('title', 'PT. BAHTERA KESELAMATAN SENTOSA - Professional Crewing & Manning Services')</title>
    
    <!-- Meta SEO -->
    <meta name="description" content="PT. BAHTERA KESELAMATAN SENTOSA - Professional Crewing & Manning Services with SIUKAK No. 58.58-R/2024 & SIUPPAK No. 65.21/2016. Your trusted international maritime partner.">
    <meta name="keywords" content="PT Bahtera Keselamatan Sentosa, Crewing Agency Indonesia, Manning Agency, Pelaut Indonesia, SIUKAK, SIUPPAK, Fishing Trawler Crew, Seafarers">
...
<body class="bg-[#F8FAFC] text-slate-800 antialiased min-h-screen flex flex-col selection:bg-amber-400 selection:text-slate-950">
    ...
    <div class="fixed bottom-6 right-6 z-40 flex flex-col items-end space-y-3">
        ...
        <a href="https://wa.me/6281234567890?text=Halo%20PT.%20Bahtera%20Keselamatan%20Sentosa,%20saya%20ingin%20berkonsultasi%20mengenai%20layanan%20crewing." target="_blank" class="w-13 h-13 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full shadow-xl flex items-center justify-center p-3.5 transition duration-200 transform hover:scale-110 group relative" title="Hubungi Kami via WhatsApp">
